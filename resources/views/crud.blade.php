        ...
        <div class="w-[35rem] mt-10">
            ...
            <div class="bg-[#1abc9c] rounded-2xl p-5 mb-5">
                ...
                <div class="w-[15rem] flex justify-between text-white">
                    <p class="font-bold text-[#2c3e50]">Name <span class="text-white">{{ $card->name }}</span></p>
                </div>
                <div class="w-[15rem] flex justify-between text-white">
                    <p class="font-bold text-[#2c3e50]">Job <span class="text-white">{{ $card->job }}</span></p>
                </div>
